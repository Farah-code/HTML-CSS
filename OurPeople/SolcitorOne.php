    ...
    <body>
        ...
        <table>
            <thead>
                <tr>
                    <td>
                        <a style="font-size: 40px" class="JLC"><img src="../../../ESTImages/Person1.jpg" width="300" height="200"/> <br> Solicitor one </a>        
                    </td>
        
                    <td>
                        <h1>if you wish to meet Solicitor one please book one of the available slots in link bellow </h1>
          ...
          <th>
             ...
             <h1 style="font-family: 'Luckiest Guy'; font-size: 25px; background-color: #000000; color:#ffffff; text-align: left;"> Solicitor one  Email </h1>  
               <h style="font-family: 'Luckiest Guy'; font-size: 20px; text-align: left;"> <a href="mailto:solicitorone@estlegal.ac.uk" class="JLLink"> solicitorone@estlegal.ac.uk </a></h>
              
                 <h1 style="font-family: 'Luckiest Guy'; font-size: 25px; background-color: #000000; color:#ffffff; text-align: left;"> Solicitor one  Phone </h1>  
               <h style="font-family: 'Luckiest Guy'; font-size: 20px; text-align: left;"> <a href="tel:  020596324825 " class="JLPhon">  020596324825 </a>  </h>
               
          <h1 style="font-family: 'Luckiest Guy'; font-size: 25px; background-color: #000000; color:#ffffff; text-align: left;"> Solicitor one  Office address </h1>  
          <br>
          <br>
        ...
        <td>
                  <div class="contactusform">
                      <h1>
                          Send to Solicitor one your questions and Solicitor one will answer you as soon as possible 
                      </h1> 
                  </div>
