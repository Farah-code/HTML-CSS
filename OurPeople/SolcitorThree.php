    ...
    <body>
        ...
        <br>
         ...
         <table>
            <thead>
                <tr>
                    <td>
                        <a style="font-size: 40px" class="JLC"><img src="../../../ESTImages/Person3.png" width="300" height="200"/> <br> Solicitor Three </a>        
                    </td>
        
                    <td>
                         <h1>if you wish to meet Solicitor three please book one of the available slots bellow</h1>
          ...
          <th>
             ...
             <h1 style="font-family: 'Luckiest Guy'; font-size: 25px; background-color: #000000; color:#ffffff; text-align: left;"> Solicitor Three  Email </h1>  
               <h style="font-family: 'Luckiest Guy'; font-size: 20px; text-align: left;"> <a href="mailto:solicitorone@estlegal.ac.uk" class="JLLink"> solicitorthree@estlegal.ac.uk </a></h>
              
                 <h1 style="font-family: 'Luckiest Guy'; font-size: 25px; background-color: #000000; color:#ffffff; text-align: left;"> Solicitor three  Phone </h1>  
               <h style="font-family: 'Luckiest Guy'; font-size: 20px; text-align: left;"> <a href="tel:  020153695874 " class="JLPhon">  020153695874 </a>  </h>
               
          <h1 style="font-family: 'Luckiest Guy'; font-size: 25px; background-color: #000000; color:#ffffff; text-align: left;"> Solicitor three  Office address </h1>  
          <br>
          <br>
        ...
        <td>
                  <div class="contactusform">
                      <h1>
                          Send to Solicitor three your questions and Solicitor three will answer you as soon as possible 
                      </h1> 
                  </div>
