    ...
    <body>
        ...
        <br>
         ...
         <table>
            <thead>
                <tr>
                    <td>
                        <a style="font-size: 40px" class="JLC"><img src="../../../ESTImages/Person4.png" width="300" height="200"/> <br> Solicitor Four </a>        
                    </td>
        
                    <td>
                         <h1>if you wish to meet Solicitor four please book one of the available slots bellow</h1>
          ...
          <th>
            ...
            <h1 style="font-family: 'Luckiest Guy'; font-size: 25px; background-color: #000000; color:#ffffff; text-align: left;"> Solicitor one  Email </h1>  
               <h style="font-family: 'Luckiest Guy'; font-size: 20px; text-align: left;"> <a href="mailto:solicitorfour@estlegal.ac.uk" class="JLLink"> solicitorfour@estlegal.ac.uk </a></h>
              
                 <h1 style="font-family: 'Luckiest Guy'; font-size: 25px; background-color: #000000; color:#ffffff; text-align: left;"> Solicitor four  Phone </h1>  
               <h style="font-family: 'Luckiest Guy'; font-size: 20px; text-align: left;"> <a href="tel:  0201525696547 " class="JLPhon">  0201525696547 </a>  </h>
               
          <h1 style="font-family: 'Luckiest Guy'; font-size: 25px; background-color: #000000; color:#ffffff; text-align: left;"> Solicitor four  Office address </h1>  
          <br>
          <br>
        ...
        <td>
                  <div class="contactusform">
                      <h1>
                          Send to Solicitor four your questions and Solicitor four will answer you as soon as possible 
                      </h1> 
                  </div>
